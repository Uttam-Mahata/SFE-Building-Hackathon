...
println("Configuring Java 21 compatibility for all projects")
...
allprojects {
    tasks.withType<org.jetbrains.kotlin.gradle.tasks.KotlinCompile>().configureEach {
        kotlinOptions {
            jvmTarget = "21"
            println("Setting Kotlin JVM target to: 21")
        }
    }
    ...
    tasks.withType<JavaCompile>().configureEach {
        ...
        println("Setting Java compatibility to: ${JavaVersion.VERSION_21}")
    }
}
